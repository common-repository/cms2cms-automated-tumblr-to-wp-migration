...
class CmsPluginFunctionsTumblr
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"  : "//wordpress.org/support/plugin/cms2cms-automated-tumblr-to-wp-migration/reviews",
    ...
    {
        $cms2cms_tumblr_access_login = get_option('cms2cms-tumblr-login');
        $cms2cms_tumblr_access_key   = get_option('cms2cms-tumblr-key');
    ...
    {
        $key   = get_option('cms2cms-tumblr-key');
        $login = get_option('cms2cms-tumblr-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            delete_option('cms2cms-tumblr-key');
            add_option('cms2cms-tumblr-key', $key);

            delete_option('cms2cms-tumblr-login');
            add_option('cms2cms-tumblr-login', $login);

            delete_option('cms2cms-tumblr-depth');
            add_option('cms2cms-tumblr-depth', $bridge_depth);
